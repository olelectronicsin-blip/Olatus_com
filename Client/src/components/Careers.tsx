...
const trainingPrograms = [
  { title: 'Full Stack Development', icon: Code, duration: '12 Weeks', gradient: 'from-blue-500 to-cyan-500' },
  { title: 'Embedded Systems Masterclass', icon: Cpu, duration: '16 Weeks', gradient: 'from-purple-500 to-pink-500' },
  { title: 'Advanced Robotics', icon: Bot, duration: '14 Weeks', gradient: 'from-orange-500 to-red-500' },
  { title: 'AI Specialist', icon: Wrench, duration: '16 Weeks', gradient: 'from-green-500 to-emerald-500' },
];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center gap-4 mb-12">
            <button
              ...
              className={`px-8 py-4 font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 ${activeTab === 'training'
            ...
            <button
              ...
              className={`px-8 py-4 font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 ${activeTab === 'jobs'
        ...
        <div>
          <section id="training" className="py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <h3 className="text-2xl font-bold text-white mb-6 pl-2 border-l-4 border-cyan-500">
                ...
                {workshopPrograms.map((program, index) => {
                  ...
                  return (
                    <div
                      ...
                      className="group relative bg-[#001a24]/80 backdrop-blur-sm rounded-xl p-8 border border-cyan-500/20 cursor-pointer transition-all duration-300 hover:transform hover:-translate-y-2 hover:shadow-xl hover:shadow-cyan-500/10"
                    >
                      <div className={`w-14 h-14 rounded-full bg-gradient-to-br ${program.gradient} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                        <Icon className="text-white" size={24} />
                      </div>

                      <h3 className="text-xl font-bold text-white mb-4 group-hover:text-cyan-400 transition-colors">{program.title}</h3>

                      <div className="flex flex-wrap items-center gap-3 text-sm text-gray-400 mb-6">
                        <div className="flex items-center gap-1.5 bg-[#002E3C] px-3 py-1 rounded-md border border-cyan-500/10">
                          <Clock size={14} className="text-cyan-400" />
                          <span>{program.duration}</span>
                        </div>
                        <div className="bg-[#002E3C] px-3 py-1 rounded-md border border-cyan-500/10 text-cyan-400 text-xs font-medium">
                          {program.level}
                        </div>
                      </div>

                      <div className="text-cyan-400 text-sm font-medium flex items-center gap-2 group-hover:gap-3 transition-all">
                        Click to see more
              ...
              <h3 className="text-2xl font-bold text-white mb-6 pl-2 border-l-4 border-gray-500">
                Training Programs
              </h3>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                {trainingPrograms.map((program, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="relative bg-[#001a24]/40 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50 grayscale opacity-80 cursor-not-allowed"
                    >
                      <div className="absolute top-4 right-4 bg-yellow-500/20 text-yellow-500 text-xs font-bold px-3 py-1 rounded-full border border-yellow-500/30">
                        COMING SOON
                      </div>
                      <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${program.gradient} flex items-center justify-center mb-4 opacity-50`}>
                        <Icon className="text-white" size={20} />
                      </div>
                      <h3 className="text-lg font-bold text-gray-400 mb-2">{program.title}</h3>
                ...
                {internshipPrograms.map((program, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <h3 className="text-lg font-bold text-gray-400 mb-3">{program.title}</h3>
                      ...
                      <button disabled className="mt-6 w-full py-2 bg-gray-800 text-gray-500 rounded text-sm font-medium cursor-not-allowed border border-gray-700">
                        Applications Closed
                      </button>
                    </div>
                  );
                    ...
                    <form
                      ...
                      onSubmit={async (e) => {
                        ...
                        const positionMap: Record<string, string> = {
                          ...
                          'Embedded Systems Masterclass': 'EMBEDDED_SYSTEMS',
                          'Advanced Robotics': 'ROBOTICS',
                          'AI Specialist': 'AI_ML',
                          'Frontend Development': 'FRONTEND',
                          'IoT Systems': 'IOT_DEVELOPMENT',
